...
public class Ventana_Menu extends javax.swing.JFrame {
    ...
    public Ventana_Menu(ArrayList<Usuario> usuarios,int punteroUsuario,ArrayList<CitaMedica> citas,int punteroCita,ArrayList<Paciente> pacientes,int punteroPaciente){
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Ventana_RegistrarPaciente citaMedica = new Ventana_RegistrarPaciente(pacientes, punteroUsuario, citas, punteroCita, usuarios, punteroPaciente);
