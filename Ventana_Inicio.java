...
public class Ventana_Inicio extends javax.swing.JFrame {
    ...
    public Ventana_Inicio(ArrayList<Usuario> usuarios,int punteroUsuario,ArrayList<CitaMedica> citas,int punteroCita,ArrayList<Paciente> pacientes ,int punteroPaciente){
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        Ventana_RegistrarUsuario registrar = new Ventana_RegistrarUsuario(usuarios,punteroUsuario,citas,punteroCita,pacientes,punteroPaciente);
